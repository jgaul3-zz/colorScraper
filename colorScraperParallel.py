...
# Set to 2 to get less vibrant color output
tweak = 2
...
def main():
    ...
    dominantColors = pool.map(getDominantColors, imgSrcs)
    dominantColors = filter(None, dominantColors)
    printElapsedTime()
